...
private[immutable] final case class ArrayBinary private[immutable] (private[immutable] var array: Array[Byte], private[immutable] var offset: Int, private var _length: Int) extends Binary with Serializable {

  override private[immutable] def depth = 0
